...
public class InsertQuestionsServlet extends HttpServlet {
	...
	private static final Logger logger = LoggerFactory.getLogger(InsertQuestionsServlet.class);
	...
	protected void doPost(HttpServletRequest request,
		...
		logger.info("Manager Factory loaded.");
		...
		logger.info("Reading questions added.");
		...
		logger.info("Cinema questions added.");
		...
		logger.info("Sport questions added.");
		...
		logger.info("Technology questions added.");
		...
		logger.info("Love questions added.");
		...
		logger.info("Music questions added.");
		...
		logger.info("Politics questions added.");
